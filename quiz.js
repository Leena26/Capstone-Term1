(function() {
  ...
  let questions = [
    {
      question: "Which of these choises is an example of human cause for poverty?",
      answers: ["No shelter", "Hurricane", "Joblessness", "Employment"],
      correctAnswer: 3
    },
    {
      question: "Which of the following is not a necessity?",
      answers: ["Water", "Car", "Shelter", "Food"],
      correctAnswer: 2
    },
    {
      question: "Which continent has the highest number of people living in poverty?",
      answers: ["Africa", "Antarctica", "Asia", "South America"],
      correctAnswer: 1
    },
    {
      question: "Which country has the highest rate of poverty?",
      answers: ["Cameroon", "London", "North Korea", "Congo"],
      correctAnswer: 4
    },
    {
      question: "Which is the odd one out??",
      answers: ["Save the Children", "Plan International", "UNICEF", "minecraft"],
      correctAnswer: 4
    }
  ];
  ...
  function displayResults() {
    ...
    <a class="share-link fb-bg" href="https://codepen.io/login" target="_blank">Codepen</a>
    <a class="share-link twitter-bg" href="https://github.com/" target="_blank">Github</a>
